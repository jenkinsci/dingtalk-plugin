import{_ as i,o as a,c as n,ae as l}from"./chunks/framework.BzF34yXA.js";const p="/dingtalk-plugin/assets/markdown-example.BOw64Rew.jpg",c=JSON.parse('{"title":"MARKDOWN 类型的消息","description":"","frontmatter":{},"headers":[],"relativePath":"examples/markdown.md","filePath":"examples/markdown.md"}'),k={name:"examples/markdown.md"};function h(t,s,e,E,r,d){return a(),n("div",null,s[0]||(s[0]=[l(`<h1 id="markdown-类型的消息" tabindex="-1">MARKDOWN 类型的消息 <a class="header-anchor" href="#markdown-类型的消息" aria-label="Permalink to &quot;MARKDOWN 类型的消息&quot;">​</a></h1><div class="language-groovy vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">groovy</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"></span>
