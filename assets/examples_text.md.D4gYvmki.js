import{_ as a,o as i,c as n,ae as l}from"./chunks/framework.BzF34yXA.js";const p="/dingtalk-plugin/assets/text-example.B0cgSOwk.jpg",g=JSON.parse('{"title":"TEXT 类型的消息","description":"","frontmatter":{},"headers":[],"relativePath":"examples/text.md","filePath":"examples/text.md"}'),t={name:"examples/text.md"};function e(h,s,k,E,r,d){return i(),n("div",null,s[0]||(s[0]=[l(`<h1 id="text-类型的消息" tabindex="-1">TEXT 类型的消息 <a class="header-anchor" href="#text-类型的消息" aria-label="Permalink to &quot;TEXT 类型的消息&quot;">​</a></h1><div class="language-groovy vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">groovy</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"></span>
